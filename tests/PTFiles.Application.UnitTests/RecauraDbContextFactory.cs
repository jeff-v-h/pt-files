...
{
    public static class PTFilesDbContextFactory
    {
        public static PTFilesDbContext Create()
        {
            var options = new DbContextOptionsBuilder<PTFilesDbContext>()
                .UseInMemoryDatabase(Guid.NewGuid().ToString())
                .Options;

            var context = new PTFilesDbContext(options);
        ...
        public static void SeedSampleData(PTFilesDbContext context)
        {
            AddPatients(context);
        ...
        public static void Destroy(PTFilesDbContext context)
        {
